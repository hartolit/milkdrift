...
- Phase 11 hardware and real-model evidence predates this contract amendment; validation of the amended tree must still name the exact CPU/CUDA commands and hardware tests executed.
