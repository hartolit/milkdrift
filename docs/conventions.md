...
|---|---|---|
| Definition | `docs/*.md` | Reusable architecture, rules, persona, and documentation conventions |
| Knowledge | `docs/knowledge/` | Reusable technical principles, evidence, and tradeoffs |
| Decision | `docs/decisions/` | Project-specific architectural decisions and rationale |
| Project reference | `docs/project/` | Current project architecture, status, components, policies, and runbooks |
| Execution | `docs/execution/` | Active analysis/plan and consolidated chronological execution history |
...
5. append execution history only when closing a meaningful execution milestone.
