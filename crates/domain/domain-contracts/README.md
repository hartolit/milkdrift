...
- Loaded models expose the complete descriptor, actual backend-visible `ExecutionDevice`, and accepted resident footprint so E0 can verify identity, metadata, capabilities, limits, selected device, and accounting together before publication.
