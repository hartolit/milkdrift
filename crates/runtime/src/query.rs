...
pub(crate) const RUN_PROJECTION_SNAPSHOT_SCHEMA_V6: u32 = 6;
    ...
    S: RunQueryStore + SnapshotStore + ?Sized,
{
    ...
    if snapshot.projection_payload_schema() != RUN_PROJECTION_SNAPSHOT_SCHEMA_V6 {
    ...
    if payload.schema_version != RUN_PROJECTION_SNAPSHOT_SCHEMA_V6
...
pub(crate) fn encode_projection_snapshot(
    ...
    Ok(serde_json::to_vec(&ProjectionSnapshotPayloadRef {
        schema_version: RUN_PROJECTION_SNAPSHOT_SCHEMA_V6,
        projection,
    })?)
}
