...
The daemon installs the lifecycle before recovery when explicitly enabled. The accepted operating
scope is recorded in [status](../../docs/product/status.md);
[activation configuration](../../docs/operations/daemon.md#controller-activation) explains the
disabled default, development feature and recovery refusal.
