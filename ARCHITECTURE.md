...
| `peer/protocol` | `milkdrift-peer-protocol::{document,identity,session,catalog,execution,artifact}` owns bounded transport-neutral protocol 1.1 messages and semantic state |
